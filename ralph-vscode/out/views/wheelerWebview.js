...
exports.WheelerWebviewProvider = void 0;
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const frameReader_1 = require("../ralph/frameReader");
const MEMORY_PATH = path.join(process.env.HOME || "", ".wheeler_memory", "memory.json");
/**
...
class WheelerWebviewProvider {
    ...
    updateContent() {
        ...
        const recent = memories
            ...
            .slice(0, 10);
        const frames = (0, frameReader_1.loadAllFrames)();
    ...
    buildHtml(entries, totalCount, frames) {
        ...
        const frameDataJson = JSON.stringify(frames.map((f) => ({ id: f.id, pixels: f.pixels, w: f.width, h: f.height })));
        return `<!DOCTYPE html>
<html>
<head>
<style>
...
exports.WheelerWebviewProvider = WheelerWebviewProvider;
//# sourceMappingURL=wheelerWebview.js.map