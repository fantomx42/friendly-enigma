...
_CC_LISTS: dict[str, list[str]] = {
    ...
    "PREP": [
        ...
        "across", "along", "against", "among", "around", "behind",
        "beside", "beyond", "near", "off", "onto", "toward", "upon",
        "within", "without",
    ],
    "CONJ": [
        "and", "or", "but", "nor", "yet", "so", "because", "although",
        "while", "if", "when", "since", "unless", "until", "whereas",
        "whether",
    ],
    "PRON": [
        "i", "me", "you", "he", "him", "she", "her", "it", "we", "us",
        "they", "them", "who", "whom", "what", "which", "that", "this",
...
def language_to_frame_batch(
    texts: list[str], size: int = 64
) -> list[np.ndarray]:
