...
- **Active Goal:** Implementing Long-Term Memory (Context) and Tool Registry (Action).
...
# BLOCKERS
- Ralph can write code but cannot *execute* it automatically (needs Tool Registry).
